...
def hf_export(llama_model, filepath, dtype=torch.float32):
    ...
    if any(layer.attention.softmax1 for layer in llama_model.layers):
        raise NotImplementedError("softmax1 models not supported yet")
